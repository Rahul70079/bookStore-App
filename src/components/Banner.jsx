        ...
        <div className="order-2 w-full mt-12 md:order-1 md:w-1/2 md:mt-36">
          <div className="space-y-8">
            ...
            <p className="text-sm md:text-xl">
             Empower your mind with the knowledge you deserve! Whether you’re a student, professional, or lifelong learner, dive into lessons that inspire curiosity and creativity.
            </p>
